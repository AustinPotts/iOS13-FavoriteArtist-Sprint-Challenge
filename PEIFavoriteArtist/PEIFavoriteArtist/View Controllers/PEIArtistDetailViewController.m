//
//  PEIArtistDetailViewController.m
//  PEIFavoriteArtist
//
...
#import "PEIArtist.h"
#import "PEIAritst+PEIArtist_NSJSONSerialization.h"
...
-(void)saveArtist:(PEIArtist *)artistRetrieved {
    if (artistRetrieved) {
        ...
        // Get the data for the Artist Retrieved to be saved
        NSData *data = [NSJSONSerialization dataWithJSONObject:[artistRetrieved artistData] options:0 error:nil];
        
        // Create access to the NSFileManager to  locate one of the standard system directories
